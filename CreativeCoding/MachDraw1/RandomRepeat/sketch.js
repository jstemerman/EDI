...
function draw() {
  ...
  for (var x = 50; x < canvasWidth; x = x + 100){
    ...
    line (x + 10, y, x + 10 + random (25, 50), y + random(40, 50));
    line (x + 50, y + 50, x + 50 - random(30, 50), y + 50 + random (35,50));
    line (x + 40, y + 50, x + 40 - random(25, 50), y + 50 + random (40,50));
    ellipse(x - 10.5, y + 25, random(8, 23), random ( 8, 19));
    ellipse(x + 60.5, y + 75, random(8, 23), random(8, 19));
